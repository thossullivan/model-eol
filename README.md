...
- **`feeds/`** - OpenAI (124 entries) and Anthropic (19 entries), generated from the
  providers' live deprecation pages plus the AWS Bedrock lifecycle page, last
  verified 2026-08-01. Every dated entry carries a source URL.
