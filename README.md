...
- **`feeds/`** - <!-- feeds-status -->Amazon (4 entries), Anthropic (33 entries), Cohere (12 entries), Google (96 entries), Mistral (40 entries) and OpenAI (201 entries), generated from the providers' live deprecation pages plus the AWS Bedrock, Google Vertex AI, and Azure Foundry lifecycle pages, feed data generated 2026-09-21<!-- /feeds-status -->. Every
